...
namespace CvPlot
{
	...
	/*extern*/ colorlist colors = colorlist();
	std::vector<col> colorlist::elements = {col(1,1,1),		  //#0
											col(255,0,0),	  //#1
											col(0,255,0),	  //#2
											col(0,0,255),	  //#3
											col(255,255,0),	  //#4
											...
											col(255,0,255),	  //#6
											col(195,173,22),  //gold
											col(145,89,171),  //purple
											col(190,190,190), //light grey
											col(182,118,118), // red/grey
											col(114,186,61),  // darker green-yellow
											col(159,0,0),	  // dark red
											col(255,149,24),  //bright orange
											col(45,84,142)	  //darker grey/blue
											};
