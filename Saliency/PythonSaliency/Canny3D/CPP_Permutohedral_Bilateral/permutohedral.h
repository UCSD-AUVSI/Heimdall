...
using namespace std; // NOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO (in a header??!??!)
...
class PermutohedralLattice {
   ...
   */
  static PHImage filter(PHImage im, PHImage ref) {
    timeval t[5];
    ...
    PHImage out(im.frames, im.width, im.height, im.channels);
